...
fun CmpButtonTertiary(
    modifier: Modifier = Modifier,
    contentColor: ContentColor = cmpButtonTertiaryColor,
...
internal val cmpButtonTertiaryColor = object : ContentColor {
    @Composable
    override fun color(): Color {
        return CmpAppTheme.colors.controlsContentTertiaryActive
    }
}